...
<body class="blue-grey darken-4 white-text">
    ...
    <ul id="mobile-links" class="sidenav sidenav-fixed blue-grey darken-3 z-depth-0">
        ...
        <li><a href="weapons.php"><i class="material-icons white-text">local_dining</i>Weapon</a></li>
        <li><a href="artifacts.php"><i class="material-icons white-text">filter_vintage</i>Artifact</a></li>
        <li><a href="consumables.php"><i class="material-icons white-text">cake</i>Consumables</a></li>
